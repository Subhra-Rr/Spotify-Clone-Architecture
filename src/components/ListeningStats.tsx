...
import { BarChart3, Clock, Trophy, Disc, Play, Sparkles, RefreshCw } from "lucide-react";
...
export function ListeningStats({ onPlayTrack }: ListeningStatsProps) {
  ...
  // Helper to draw clean custom SVG chart for hourly trends
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="p-5 rounded-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/5 flex items-center gap-4">
              ...
              <div>
                <span className="text-[11px] text-gray-400 font-bold uppercase tracking-wider block">Estimated Listening Time</span>
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/5 flex items-center gap-4">
              ...
              <div>
                <span className="text-[11px] text-gray-400 font-bold uppercase tracking-wider block">Total Plays Recorded</span>
            ...
            <div className="p-5 rounded-2xl bg-gradient-to-br from-white/[0.03] to-white/[0.01] border border-white/5 flex items-center gap-4">
              ...
              <div>
                ...
                <span className="text-2xl font-black truncate max-w-[150px] block">
